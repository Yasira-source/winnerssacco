...
class ScholarshipDetails extends StatefulWidget {
  ScholarshipDetails({Key key, this.image, this.title, this.website, this.email, this.address, this.description, this.phone}) : super(key: key);
  String image;
  String title;
  String description;
  String phone;
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Center(
              child: InkWell(
                  child: const Text('View More',style: TextStyle(color:Color(0xffC2151C) ,fontSize: 15,fontWeight: FontWeight.bold),),
